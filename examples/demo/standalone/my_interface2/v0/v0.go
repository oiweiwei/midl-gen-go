...
var (
	// import guard
	GoPackage = "standalone"
)

var (
	// Syntax UUID
	MyInterface2SyntaxUUID = &uuid.UUID{TimeLow: 0x6bffd098, TimeMid: 0xa112, TimeHiAndVersion: 0x3610, ClockSeqHiAndReserved: 0x98, ClockSeqLow: 0x33, Node: [6]uint8{0x1, 0x28, 0x92, 0x2, 0x1, 0x63}}
	// Syntax ID
	MyInterface2SyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: MyInterface2SyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// my_interface2 interface.
type MyInterface2Client interface {
...
type xxx_DefaultMyInterface2Client struct {
	cc dcerpc.Conn
}

func (o *xxx_DefaultMyInterface2Client) TestCall(ctx context.Context, in *TestCallRequest, opts ...dcerpc.CallOption) (*TestCallResponse, error) {
...
func (o *xxx_DefaultMyInterface2Client) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultMyInterface2Client) Conn() dcerpc.Conn {
	return o.cc
}

func NewMyInterface2Client(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (MyInterface2Client, error) {
	cc, err := cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(MyInterface2SyntaxV0_0))...)
	if err != nil {
		return nil, err
	}
	return &xxx_DefaultMyInterface2Client{cc: cc}, nil
}
...
func (o *xxx_TestCallOperation) OpName() string { return "/my_interface2/v0/TestCall" }
...
// OpName returns the operation name of TestCall operation.
func (o *TestCallRequest) OpName() string { return "/my_interface2/v0/TestCall" }
