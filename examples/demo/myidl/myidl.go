...
func (o MyInterfaceStructNullMask) Set(v MyInterfaceStructNullMask) MyInterfaceStructNullMask {
	return o | v
}

func (o MyInterfaceStructNullMask) Unset(v MyInterfaceStructNullMask) MyInterfaceStructNullMask {
	return o &^ v
}
