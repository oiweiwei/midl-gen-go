...
import (
	...
	idcominterface "github.com/oiweiwei/midl-gen-go/examples/demo/myidl/idcominterface/v0"
)
...
type Client interface {
	...
	IDcomInterface() idcominterface.IDcomInterfaceClient
...
func (o *xxx_DefaultClient) IDcomInterface() idcominterface.IDcomInterfaceClient {
	return o.iDcomInterface
}

func NewClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (Client, error) {

	opts = append(opts,
		dcerpc.WithAbstractSyntax(idcominterface.IDcomInterfaceSyntaxV0_0),
	...
	iDcomInterfaceSubConn, err := sub.SubConn(ctx, idcominterface.IDcomInterfaceSyntaxV0_0)
	if err != nil {
		// XXX: use main subconnection as a last resort
		// it was noticed that we can reuse the main connection for dcom interfaces
		iDcomInterfaceSubConn = sub
	}

	o.iDcomInterface, err = idcominterface.NewIDcomInterfaceClient(ctx, iDcomInterfaceSubConn, append(opts, dcerpc.WithNoBind(iDcomInterfaceSubConn))...)
	return o, nil
}
...
func (o *xxx_DefaultClient) IPID(ctx context.Context, ipid *dcom.IPID) Client {
	...
	return &xxx_DefaultClient{
		...
		iDcomInterface: o.iDcomInterface.IPID(ctx, ipid),
		cc:             o.cc,
	}
}
